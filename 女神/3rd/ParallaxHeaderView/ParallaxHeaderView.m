...
//    self.bluredImageView = [[UIImageView alloc] initWithFrame:subView.frame];
    ...
    //t test code
//    [self.imageScrollView setBackgroundColor:UIRedColor];
//    [self.imageView setBackgroundColor:UIGreenColor];
//    [self.subView setBackgroundColor:UIBlueColor];
//    [self setBackgroundColor:[UIColor orangeColor]];
//    
//    _imageScrollView.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin | UIViewAutoresizingFlexibleTopMargin | UIViewAutoresizingFlexibleBottomMargin | UIViewAutoresizingFlexibleHeight | UIViewAutoresizingFlexibleWidth;
//    [self addSubview:self.imageScrollView];
    //test code end here
    [self refreshBlurViewForNewImage];
}
